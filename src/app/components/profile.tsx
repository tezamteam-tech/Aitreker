                    ...
                    <button
                      ...
                      onClick={async () => {
                        ...
                        try {
                          ...
                          const lines: string[] = [];
                          lines.push('═══════════════════════════════════════');
                          lines.push(isRu ? '  BECOME — Экспорт журнала' : '  BECOME — Journal Export');
                          ...
                          lines.push('');
                          lines.push('───────────────────────────────────────');
                          lines.push(isRu ? 'Сгенерировано приложением BECOME' : 'Generated by BECOME app');
                          lines.push('@BECOMEAI_BOT');
                          ...
                          a.href = url;
                          a.download = `become-journal-${new Date().toISOString().slice(0, 10)}.txt`;
                          a.click();
